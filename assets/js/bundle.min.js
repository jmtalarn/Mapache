    ...
    var _createClass = function() {
        ...
        mapacheRelated = function() {
            function mapacheRelated(elem, pageUrl) {
                _classCallCheck(this, mapacheRelated), this.elem = elem, this.postID = elem.attr("mapache-post-id"), this.postTotal = elem.attr("mapache-post-total"), this.postTags = elem.attr("mapache-tag").split(','), this.urlApi = ghost.url.api("posts", {
                    include: "tags"
