! function(modules) {
    ...
    ! function() {
        ...
        $(".share").bind("click", function(e) {
            e.preventDefault();
            var share = new _app2["default"]($(this)); //var share = new _app2["default"](this$);
            share.godoShare()
    ...
    var _createClass = function() {
        ...
        mapacheRelated = function() {
            function mapacheRelated(elem, pageUrl) {
                _classCallCheck(this, mapacheRelated), this.elem = elem, this.postID = elem.attr("mapache-post-id"), this.postTotal = elem.attr("mapache-post-total"), this.postTags = elem.attr("mapache-tag").split(',').map(Number).filter(Boolean), this.urlApi = ghost.url.api("posts", {
                    include: "tags"
            ...
            return _createClass(mapacheRelated, [{
                ...
                value: function(res) {
                    ...
                    res.forEach(function(post) {
                        (post.tags.map(function(a) {return a.id;}).map(function (needle) { return _this.postTags.indexOf(needle);}).indexOf(-1) == -1 || _this.postTags.map(function (needle) { return post.tags.map(function(a) {return a.id;}).indexOf(needle);}).indexOf(-1) == -1) && post.id != _this.postID && _this.count < _this.postTotal && (html += _this.mapacheTemplate(post), _this.count++)
