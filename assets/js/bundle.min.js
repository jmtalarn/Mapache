    ...
    var _createClass = function() {
        ...
        mapacheRelated = function() {
            function mapacheRelated(elem, pageUrl) {
                _classCallCheck(this, mapacheRelated), this.elem = elem, this.postID = elem.attr("mapache-post-id"), this.postTotal = elem.attr("mapache-post-total"), this.postTags = elem.attr("mapache-tag").split(',').map(Number), this.urlApi = ghost.url.api("posts", {
                    include: "tags"
            ...
            return _createClass(mapacheRelated, [{
                ...
                value: function(res) {
                    ...
                    res.forEach(function(post) {
                        for (var i = 0; i < post.tags.length; i++) (_this.postTags.indexOf(post.tags[i].id) != -1) && post.id != _this.postID && _this.count < _this.postTotal && (html += _this.mapacheTemplate(post), _this.count++)
